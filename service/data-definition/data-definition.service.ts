...
export class _DataDefinitionService {

  constructor(public http: HttpClient, public storage: SessionStorageService, public loader: LoaderService, public parser: ParserService, public message: MessageService) { }
